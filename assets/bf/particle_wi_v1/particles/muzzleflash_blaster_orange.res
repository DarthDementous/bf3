...
particleSystemTemplate muzfllzorng
{
    particleColour []
    {
    ...
    particleTextureColour = "textures/particle_laser_muzzleflash_orange_x2"
...
particleSystemTemplate muzfl_lz_blu_1
{
    ...
    particleTextureNormal = "textures/particle_laser_pulse_normal"
...
particleEffectTemplate muzfl_lz_orng
{
    optimise = "false"
    variations
    {
