...
/*   12   */     mad r2, r4.x, c3.xywz, r2.xzwy
/*   13   */     mov oPos, r2.xywz
/*    1.1 */     alloc interpolators
/*    2.0 */     exec
/*   14   */     add r4.xy, r3.zy, -r3.xw
               + rcp r1.x, r2.z
/*   15   */     mov o4.xyz, c2.xyz
/*   16   */     mul o3.xyz, r0.xyz, c255.y
/*   17   */     mad o2.xy, r4.xy, r1.zw, r3.xw
/*   18   */     movs o1.x, r1.y
/*   19   */     mov o0, r2.xywz
/*    2.1 */     exec
/*   20   */     mad r1.x, r2.w, r1.x, -c0.x
/*   21   */     add r1.y, c1.y, -c1.x
               + rcp r1.x, r1.x
/*   22   */     adds r1.z, r1.xx
/*   23   */     mul r0.xy, r1.zx, c0.y
/*   24   */     subsc r0.z, -c1.x, -r0.y
/*   25   */     min r1.x, r0.x, c255.x
               + rcp r0.x, r1.y
/*    3.0 */     exece
/*   26   */     mul o3.w, r1.x, r0.w
/*   27   */     mul_sat r0.x, r0.z, r0.x
/*   28   */     mulsc o4.w, c2.w, r0.x
/*    3.1 */     cnop
