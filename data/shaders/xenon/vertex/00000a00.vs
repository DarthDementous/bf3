...
/*   37   */     add o4.xyz, r5.xyz, r4.xyz
/*   38   */     add r1.x, r5.w, r4.w
               + addsc r0.x, c11.z, r1.w
/*   39   */     add r7.xy, -r0.x, c10.yx
               + rsq r0.x, r1_abs.x
/*   40   */     mul r5.xyz, r0.x, r3.wzx
/*   41   */     add r4.xyz, r5.xyz, r5.xyz
/*    4.0 */     exec
/*   42   */     mul r3.xw, r5.x, r4.yx
               + movs r0._, r0.x
/*   43   */     mul r5, r5.yz, r4.yyxz
               + muls_prev r0.x, r3_abs.y
/*   44   */     mul r6.xyz, r0.x, r4.zyx
               + adds r0.x, r5.wx
/*   45   */     add r4.z, r3.x, r6.x
               + movs r0._, r5.z
/*   46   */     add r8.x, r5.y, r6.z
               + adds_prev r4.x, -r6.y
/*   47   */     add r6.y, r5.z, r6.y
               + movs r0._, r3.x
/*    4.1 */     exec
/*   48   */     add r6.z, r5.y, -r6.z
               + adds_prev r8.y, -r6.x
/*   49   */     mul r3.xyz, r0.y, c4.xyz
               + movs r0._, r3.w
/*   50   */     add r1.x, r5.w, r3.w
               + adds_prev r2.x, r5.x
/*   51   */     add r2.yzw, -r2.yyzw, c7.xxyz
               + subsc r4.y, c255.y, r0.x
/*   52   */     add r6.x, -r2.x, c255.y
               + subsc r8.z, c255.y, r1.x
/*   53   */     dp3 o0.x, r6.zxy, r2.wyz
/*    5.0 */     exec
/*   54   */     dp3 o0.z, r8.zxy, r2.wyz
/*   55   */     dp3 r2.x, r3.zxy, r4.zxy
/*   56   */     dp3 r3.y, r8.xyz, c4.xyz
/*   57   */     dp3 r3.z, r8.zxy, c5.zxy
/*   58   */     dp3 r5.x, r6.zxy, c4.zxy
/*   59   */     dp3 r5.y, r6.zxy, c5.zxy
/*    5.1 */     exec
/*   60   */     dp3 r3.w, r8.zxy, c6.zxy
/*   61   */     dp3 r5.z, r6.zxy, c6.zxy
               + subsc r6.x, c8.y, r0.w
/*   62   */     mul r8.xyz, r4.zxy, r0.y
               + subsc r6.y, c8.x, r0.w
/*   63   */     dp3 o0.y, r8.xyz, r2.wyz
...
/*   67   */     mul r4.zw, r2.w, r7.xxxy
               + muls_prev r0.x, r7.x
/*   68   */     dp3 r3.x, r5.zxy, r1.wyz
               + movs r0._, r3.w
/*   69   */     mul r5, r5.xxy, r6.xywz
               + muls_prev r0.y, r7.y
/*   70   */     mul r7, r3.yyz, r6
               + adds r5.x, r5.xw
/*   71   */     dp3 r3.z, r3.wyz, r1.wyz
               + adds r0.w, r7.xz
/*    6.1 */     exec
/*   72   */     mul r6, r2.xxy, r6
               + adds r0.z, r7.yw
