...
0d: c80f0001 001b8800 a1060700	      ALU:	MULv	R1 = R6.wwww, C7.xwzy
0e: 00270509 02c0c0c6 e0050608	      ALU:	ADDv	R9.xyz_ = R5.xyzz, -R6.xyzz
                          						    	ADDs	R5._y__ = R8.zzzz
0f: 08410504 00151561 f0040402	      ALU:	DOT3v	R4.x___ = R4.yzww, R4.yzww
                          						    	MULs	R5.__z_ = R2.yyxx
10: 4c810905 00bebeb1 f0090902	      ALU:	DOT3v	R5.x___ = R9.zxyy, R9.zxyy
                          						    	RECIP_IEEE	R9.___w = R2.yyyy
...
15: 0c870404 00c0b4c6 e1060502	      ALU:	MULv	R4.xyz_ = R6.xyzz, R5.xzyy
                          						    	MUL_PREVs	R4.___w = R2.zzzz
...
19: 58110408 006c1b6c e10b0884	      ALU:	MULv	R8.x___ = R11.xxxx, R8.wwww
                          						    	RECIPSQ_IEEE	R4.x___ = abs(R4).xxxx
1a: 4c870505 00b46c6c e1060402	      ALU:	MULv	R5.xyz_ = R6.xzyy, R4.xxxx
                          						    	RECIP_IEEE	R5.___w = R2.xxxx
...
1d: c8030002 00c5c500 e00a0400	      ALU:	ADDv	R2.xy__ = R10.yzzz, R4.yzzz
      0000401e 00001200     	EXEC ADDR(0x1e) CNT(0x4) BOOL_ADDR(0x80)
1e: c80f0001 00b18800 ab020601	      ALU:	MULADDv	R1 = R1, R2.yyyy, C6.xwzy
1f: c80f0001 006c3494 ab020501	      ALU:	MULADDv	R1 = R1.xzwy, R2.xxxx, C5.xzyw
20: c80f0001 006c3400 ab0a0401	      ALU:	MULADDv	R1 = R1, R10.xxxx, C4.xzyw
...
28: 4c190104 001a6c1b e0050401	      ALU:	ADDv	R4.x__w = R5.zwww, R4.xxxx
                          						    	RECIP_IEEE	R1.x___ = R1.wwww
29: 14108002 0000001b e2000006	      ALU:	MAXs	export0.x___ = R6.wwww
2a: c8078004 00c0c000 22030300	      ALU:	MAXv	export4.xyz_ = C3.xyzz, C3.xyzz
2b: c8078003 00c01b00 a100ff00	      ALU:	MULv	export3.xyz_ = R0.xyzz, C255.wwww
2c: c80f8001 00a0d028 eb050403	      ALU:	MULADDv	export1 = R3.xwxw, R5.xyxy, R4.xywz
2d: 14108000 0000001b e2000002	      ALU:	MAXs	export0.x___ = R2.wwww
      0000602e 00001200     	EXEC ADDR(0x2e) CNT(0x6) BOOL_ADDR(0x80)
2e: c8010001 01b16c6c cb010101	      ALU:	MULADDv	R1.x___ = -C1.xxxx, R1.yyyy, R1.xxxx
...
33: 4c110001 006c6cb1 a300ff01	      ALU:	MINv	R1.x___ = R0.xxxx, C255.xxxx
                          						    	RECIP_IEEE	R0.x___ = R1.yyyy
      00003034 00002200     	EXEC_END ADDR(0x34) CNT(0x3) BOOL_ADDR(0x80)
34: c8088003 006c1b00 e1010000	      ALU:	MULv	export3.___w = R1.xxxx, R0.wwww
35: c9010000 00c66c00 e1000000	      ALU:	MULv	R0.x___ = R0.zzzz, R0.xxxx CLAMP
36: a8808004 00000000 c2000003	      ALU:	MUL_CONST_0	export0.___w = C3.w, R0.x
