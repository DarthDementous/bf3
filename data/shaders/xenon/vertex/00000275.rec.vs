...
0c: 05f83000 00000e78 00000000	      FETCH:	VERTEX	R3.x_y_ = R0.x FMT_1_REVERSEUNSIGNED NORMALIZED STRIDE(0) CONST(31, 2) src_reg_am=0 dst_reg_am=0 num_format_all=0 signed_rf_mode_all=0 exp_adjust_all=0
0d: 05f87000 00000fc8 00000000	      FETCH:	VERTEX	R7.xy__ = R0.x FMT_1_REVERSEUNSIGNED NORMALIZED STRIDE(0) CONST(31, 2) src_reg_am=0 dst_reg_am=0 num_format_all=0 signed_rf_mode_all=0 exp_adjust_all=0
...
11: c8070006 00bc6d1b 6cfe0105	      ALU:	CNDEv	R6.xyz_ = R5.wwww, C254.xxyy, R1.yxxx
12: 4c280303 001b1bc6 e1828201	      ALU:	MULv	R3.___w = abs(R2).wwww, abs(R2).wwww
                          						    	RECIP_IEEE	R3._y__ = R1.zzzz
13: c8030001 00b16d00 e1030100	      ALU:	MULv	R1.xy__ = R3.yyyy, R1.yxxx
14: b4430000 00c46c00 0102fd02	      ALU:	MULv	R0.xy__ = C2.xzzz, C253.xxxx
                          						    	ADD_CONST_1	R0.__z_ = C2.w, R1.x
15: c8040000 00b1c6c6 ab01fd00	      ALU:	MULADDv	R0.__z_ = R0.zzzz, R1.yyyy, C253.zzzz
16: c8040000 00c6b16c 8b00fdfd	      ALU:	MULADDv	R0.__z_ = C253.xxxx, R0.zzzz, C253.yyyy
      00006017 00001200     	EXEC ADDR(0x17) CNT(0x6) BOOL_ADDR(0x80)
17: 2c440001 00bebec6 f0020200	      ALU:	DOT3v	R1.__z_ = R2.zxyy, R2.zxyy
                          						    	FRACs	R0.__z_ = R0.zzzz
18: c8040000 00c61b6c 8b00fdff	      ALU:	MULADDv	R0.__z_ = C255.xxxx, R0.zzzz, C253.wwww
19: c0480000 00b11bc6 e1030100	      ALU:	MULv	R0.___w = R3.yyyy, R1.wwww
                          						    	SIN	R0.__z_ = R0.zzzz
1a: c8010000 006cc600 e0000000	      ALU:	ADDv	R0.x___ = R0.xxxx, R0.zzzz
1b: a84c0304 00ecb1c0 810310fe	      ALU:	MULv	R4.__zw = R3.xxxz, C16.yyyy
                          						    	MUL_CONST_0	R3.__z_ = C254.z, R0.x
1c: c8010000 00c1c000 f0030600	      ALU:	DOT3v	R0.x___ = R3.yyzz, R6.xyzz
      0000601d 00001200     	EXEC ADDR(0x1d) CNT(0x6) BOOL_ADDR(0x80)
1d: b0400000 00000000 c2000002	      ALU:	ADD_CONST_0	R0.__z_ = C2.w, R0.x
1e: c8040000 00c6b16c 8b00fdfd	      ALU:	MULADDv	R0.__z_ = C253.xxxx, R0.zzzz, C253.yyyy
1f: 2c410083 066c6cc6 22060600	      ALU:	MAXv	R3.x___ = -|C6|.xxxx, -|C6|.xxxx
                          						    	FRACs	R0.__z_ = R0.zzzz
20: c8040000 00c61b6c 8b00fdff	      ALU:	MULADDv	R0.__z_ = C255.xxxx, R0.zzzz, C253.wwww
21: c4140003 00c61bc6 e1030500	      ALU:	MULv	R3.__z_ = R3.zzzz, R5.wwww
                          						    	COS	R0.x___ = R0.zzzz
...
24: c8020003 006c1b00 e1000500	      ALU:	MULv	R3._y__ = R0.xxxx, R5.wwww
25: c8070000 00bec300 e0010300	      ALU:	ADDv	R0.xyz_ = R1.zxyy, R3.wyzz
26: c80f0001 00b10000 8b001314	      ALU:	MULADDv	R1 = C20, R0.yyyy, C19
27: c80f0001 001b3434 ab001201	      ALU:	MULADDv	R1 = R1.xzyw, R0.wwww, C18.xzyw
28: c80f803e 00c60034 ab001101	      ALU:	MULADDv	export62 = R1.xzyw, R0.zzzz, C17	; POSITION
      00000000 0000c400     	ALLOC PARAM/PIXEL SIZE(0x0)
      00006029 00001200     	EXEC ADDR(0x29) CNT(0x6) BOOL_ADDR(0x80)
29: c8020001 001bb11b 8d02fefe	      ALU:	CNDGTEv	R1._y__ = C254.wwww, R2.wwww, C254.yyyy
2a: 58170406 0062c06c a1050580	      ALU:	MULv	R6.xyz_ = R5.zyxx, C5.xyzz
                          						    	RECIPSQ_IEEE	R4.x___ = abs(R0).xxxx
2b: 14050001 001a6c6c a1071004	      ALU:	MULv	R1.x_z_ = R7.zwww, C16.xxxx
2c: 0c8e0103 02368c1b a0000a82	      ALU:	ADDv	R3._yzw = R0.zzyw, -C10.xxzy
                          						    	MUL_PREVs	R1.___w = abs(R2).wwww
2d: 14170005 006c651b e1040200	      ALU:	MULv	R5.xyz_ = R4.xxxx, R2.yzxx
                          						    	MAXs	R0.x___ = R0.wwww
2e: b81e0402 008c8c80 c005050a	      ALU:	ADDv	R2._yzw = R5.xxzy, R5.xxzy
                          						    	SUB_CONST_0	R4.x___ = C10.y, R0.x
      0000602f 00001200     	EXEC ADDR(0x2f) CNT(0x6) BOOL_ADDR(0x80)
2f: b8210402 0012be42 9003090a	      ALU:	DOT3v	R2.x___ = R3.zyww, C9.zxyy
                          						    	SUB_CONST_0	R4._y__ = C10.x, R0.z
30: c8038006 00b01b00 a1071000	      ALU:	MULv	export6.xy__ = R7.xyyy, C16.wwww
31: c88fc007 006cc0c0 ad030506	      ALU:	CNDGTEv	export7 = R6.xyzz, R3.xxxx, C5.xyzz
                          						    	RETAIN_PREV	export0.___w = R6.xyzz
32: c8018005 006e6d1b 91010000	      ALU:	DOT2ADDv	export5.x___ = C0.wwww, R1.zxxx, C0.yxxx
33: c8028005 006e6d1b 91010101	      ALU:	DOT2ADDv	export5._y__ = C1.wwww, R1.zxxx, C1.yxxx
34: c8048005 00c76d1b 91040303	      ALU:	DOT2ADDv	export5.__z_ = C3.wwww, R4.wzzz, C3.yxxx
      00006035 00001200     	EXEC ADDR(0x35) CNT(0x6) BOOL_ADDR(0x80)
35: c8088005 00c76d1b 91040404	      ALU:	DOT2ADDv	export5.___w = C4.wwww, R4.wzzz, C4.yxxx
36: b8450401 00b01bc1 c105020a	      ALU:	MULv	R1.x_z_ = R5.xyyy, R2.wwww
                          						    	SUB_CONST_0	R4.__z_ = C10.z, R0.y
37: b01f0005 00c435c0 e105020f	      ALU:	MULv	R5 = R5.xzzz, R2.yzyw
                          						    	ADD_CONST_0	R0.x___ = C15.z, R2.x
38: 00870106 001b15bc e1010205	      ALU:	MULv	R6.xyz_ = R1.wwww, R2.yzww
                          						    	ADDs	R1.___w = R5.xxyy
39: b8240208 006cb180 c001060e	      ALU:	ADDv	R8.__z_ = R1.xxxx, R6.yyyy
...
3c: 14010003 0012be1b b0030705	      ALU:	DOT3v	R3.x___ = R3.zyww, C7.zxyy
3d: 04140607 021b6c6c e0050606	      ALU:	ADDv	R7.__z_ = R5.wwww, -R6.xxxx
                          						    	ADD_PREVs	R6.x___ = R6.xxxx
3e: 14020003 0012bec6 b0030805	      ALU:	DOT3v	R3._y__ = R3.zyww, C8.zxyy
3f: 042c0700 00acacc6 a0030f06	      ALU:	ADDv	R0.__zw = R3.xxxy, C15.xxxy
...
41: bc2d0805 00b1f082 810107fe	      ALU:	MULv	R5.x_zw = R1.yyyy, C7.xyyz
...
46: b841020c 00cfbe41 d005080e	      ALU:	DOT3v	R12.x___ = R5.wxzz, R8.zxyy
                          						    	SUB_CONST_0	R2.__z_ = C14.x, R0.y
      00006047 00001200     	EXEC ADDR(0x47) CNT(0x6) BOOL_ADDR(0x80)
47: b8140b05 00626282 9007080c	      ALU:	DOT3v	R5.__z_ = R7.zyxx, C8.zyxx
                          						    	SUB_CONST_0	R11.x___ = C12.y, R0.z
48: b8210b05 00626242 9007070c	      ALU:	DOT3v	R5.x___ = R7.zyxx, C7.zyxx
                          						    	SUB_CONST_0	R11._y__ = C12.x, R0.z
49: b8410b0a 00bebe83 9006070d	      ALU:	DOT3v	R10.x___ = R6.zxyy, C7.zxyy
                          						    	SUB_CONST_0	R11.__z_ = C13.y, R0.w
4a: b8820b0a 00bebe43 9006080d	      ALU:	DOT3v	R10._y__ = R6.zxyy, C8.zxyy
                          						    	SUB_CONST_0	R11.___w = C13.x, R0.w
4b: 14070000 0065b1b1 e1080104	      ALU:	MULv	R0.xyz_ = R8.yzxx, R1.yyyy
4c: 0c280705 0062626c b0070906	      ALU:	DOT3v	R5.___w = R7.zyxx, C9.zyxx
                          						    	MUL_PREVs	R7._y__ = R6.xxxx
      0000604d 00001200     	EXEC ADDR(0x4d) CNT(0x6) BOOL_ADDR(0x80)
4d: 1404000a 00bebe6c b0060904	      ALU:	DOT3v	R10.__z_ = R6.zxyy, C9.zxyy
...
50: 0c22010c 0065beb1 b0000802	      ALU:	DOT3v	R12._y__ = R0.yzxx, C8.zxyy
                          						    	MUL_PREVs	R1._y__ = R2.yyyy
51: 1404000c 00cd621b b0000905	      ALU:	DOT3v	R12.__z_ = R0.yxzz, C9.zyxx
...
59: 14080003 02bebec6 b00a0b05	      ALU:	DOT3v	R3.___w = R10.zxyy, -C11.zxyy
...
5c: 14480307 02bebe1b b00c0b03	      ALU:	DOT3v	R7.___w = R12.zxyy, -C11.zxyy
...
60: 00410503 02cfbe6b b0050b07	      ALU:	DOT3v	R3.x___ = R5.wxzz, -C11.zxyy
