...
//	IN_CAM_MOVE_UP_DOWN		= "padButton(UP,DOWN);mouseButton(LEFT,RIGHT);keyboard('T','U')"
	IN_CAM_MOVE_UP_DOWN		= "padButton(UP,DOWN);keyboard('T','U')"
	...
	IN_MENU_BACK			= "padButton(TRIANGLE);keyboard(BACKSPACE)"
...
//	IN_CAM_MOVE_FORWARDS_BACKWARDS_EDITOR	= "padStick(LY);keyboard('W','S')"
//	IN_CAM_MOVE_LEFT_RIGHT_EDITOR		= "padStick(LX);keyboard('D','A')"
//	IN_CAM_LOOK_UP_DOWN_EDITOR		= "padStick(RY);mouseMove(Y)"
//	IN_CAM_LOOK_LEFT_RIGHT_EDITOR		= "padStick(RX);mouseMove(X)"
