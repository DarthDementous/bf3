...
template fp_cis_blaster_rifle_boned : animfirstpersongun
{
    render
    {
...
template fp_cis_blaster_rifle_nopromo : animfirstpersongun
{
    render
    {
	model	= "weapon/misc/misc_durge/misc_durge_firstperson_nopromo"
    }
}

template w_cis_br : gun
{
    dynamiclight light
    {
	exponent    = 1.f
...
template o_gun_cis_br : inventoryObjectTypeWeapon 
{
    details
    {
        singular = "CIS Blaster Pistol"
	singularPrefix = "the"
...
/* template pickup_gun_dh17br: kitPickupProp
{
	...
	contents
	{
	    pickupkittemplate = "pickup_gun_dh17br"
