...
template gunanims_repsg
{
    ...
    {
	script	    = "sfx(fire);sfx(addfire);useAmmo;setUbiks(fire);nextFrame(fire)" //|particleUp[muzPistolaUp]|particleCart[bulletClip])"
...
template w_rep_shotgun : gun
{
	...
	soundmap_npc	    = "sndmap_rpsg"
	soundmap_player	    = "sndmap_rpsgpla"
