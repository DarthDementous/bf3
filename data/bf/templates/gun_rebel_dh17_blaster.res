...
template fp_dh17_blaster_rifle_boned : animfirstpersongun
{
    render
    {
...
template fp_dh17_blaster_rifle_nopromo : animfirstpersongun
{
    render
    {
	model	= "weapon/rep/rep_dh17_blasterpistol_firstperson_nopromo"
    }
}

template w_dh17_br : gun
{
    dynamiclight light
    {
	exponent    = 1.f
