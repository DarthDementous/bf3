...
template fp_dc17_blaster_rifle_boned : animfirstpersongun
{
    render
    {
...
template fp_dc17_blaster_rifle_nopromo : animfirstpersongun
{
    render
    {
	model	= "weapon/rep/rep_dc17_pistol_firstperson_nopromo"
    }
}

template w_dc17_br : gun
{
    dynamiclight light
    {
	exponent    = 1.f
...
/* template pickup_gun_dc17br: kitPickupProp
{
	...
	contents
	{
	    pickupkittemplate = "pickup_gun_dc17br"
