...
*/
	...
	IN_MOTION_PUSH			= "motion(PUSH);ignore"	
	IN_MOTION_PULL			= "motion(PULL);ignore"
	...
	IN_MOTION_BLOCK			= "motion(BLOCK);ignore"
	IN_MOTION_RAISED		= "motion(CHOKE);ignore"
	IN_MOTION_DOWN			= "motion(DOWN);ignore"
	IN_MOTION_UP			= "motion(UP);ignore"
	IN_MOTION_SEPERATE		= "motion(SEPERATE);ignore"
