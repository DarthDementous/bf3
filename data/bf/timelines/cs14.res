timelineCreateProp e0
{
    triggerTime = 0.f
    propname = "prop0"
    propfile = "characters/villains/imperial_officer"
...
{
    triggerTime = 1.0f
    animname = "AN_cs14m_cam"
}
timelinePlayAnim p0
{
    triggerTime = 1.0f
    propname = "prop0"
    animname = "AN_cs14m_prop0"
}
timelinePlayAnim p1
{
    triggerTime = 1.0f
    propname = "prop1"
    animname = "AN_cs14m_prop1"
}
timelinePlayAnim p2
{
    triggerTime = 1.0f
    propname = "prop2"
    animname = "AN_cs14m_prop2"
}
timelinePlayAnim p3
{
    triggerTime = 1.0f
    propname = "prop3"
    animname = "AN_cs14m_prop3"
}
timelinePlayAnim p4
{
    triggerTime = 1.0f
    propname = "prop4"
    animname = "AN_cs14m_prop4"
}
timelinePlayAnim p5
{
    triggerTime = 1.0f
    propname = "prop5"
    animname = "AN_cs14m_prop5"
}
timelinePlayAnim p6
{
    triggerTime = 1.0f
    propname = "prop6"
    animname = "AN_cs14m_prop6"
}
