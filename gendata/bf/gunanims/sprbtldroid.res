...
template ga_sprbtldroid
{
    animmap = "cis_sprbtl"
    prefix = "N"
    slots = "grenad;raise;reload;down;lower;idle;noAim;melee;fire;sprnt;toSpr;frSpr;jump;toJmp;frJmp"
    ...
    gunStateReload Nreload_0
    {
        ...
        time = 2.20
        chrBones = "middle;upperbody;ruparm+;luparm+"
        canZoom = "no"
