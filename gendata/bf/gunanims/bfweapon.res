...
template ga_rep_shotgun : ga_bfweapon
{
    animmap = "rshotgun"
}

template ga_rep_pistol : ga_bfweapon
{
    animmap = "rpistol"
    slots += ";charg;dchar"
...
template ga_rep_sniper : ga_bfweapon
{
    animmap = "rsniper"
}

template ga_rep_sonic : ga_bfweapon
{
    animmap = "rsonic"
}
